...
# Additional info on PostGIS configuration for Heroku at
# https://devcenter.heroku.com/articles/postgis#setting-up-postgis-with-rails
# and https://github.com/cyberdelia/heroku-geo-buildpack/
  ...
  initializer "active_record.initialize_database.override" do |app|
    ...
    ActiveSupport.on_load(:active_record) do
      if url = ENV['DATABASE_URL']
        ...
        puts ENV.keys
        ENV['HEROKU_POSTGRESQL_MAROON_URL']
        parsed_url = URI.parse(ENV['HEROKU_POSTGRESQL_MAROON_URL'])
        config =  {
          adapter:             'postgis',
